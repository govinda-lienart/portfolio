...
| `IMG_1839.MOV` | 5 fish | Re-identification work (Stage 5) |
| `IMG_2349.MOV` | 4 fish | Tracker ground truth (Stage 4), behaviour analysis (Stage 6), feeding experiment (Stage 7) |
